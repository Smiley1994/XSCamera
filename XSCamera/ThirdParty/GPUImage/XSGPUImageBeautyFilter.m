...
NSString *const kFSKGPUImageBeautyFragmentShaderString = SHADER_STRING
(
...
#endif
@implementation XSGPUImageBeautyFilter
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kFSKGPUImageBeautyFragmentShaderString])) {
        return nil;
    }
    _toneLevel = 0.47;
    _beautyLevel = 0.42;
